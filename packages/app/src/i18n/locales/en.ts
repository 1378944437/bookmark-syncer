...
export const dictionary: Record<string, string> = {
  ...
  "settings.section.sync": "Sync & Scope",
  "settings.section.preferences": "Preferences & Device",
  "settings.section.system": "About & Support",

  "settings.item.webdav.label": "WebDAV Settings",
  "settings.item.webdav.desc": "Server connection & provider templates",
  "settings.item.security.label": "End-to-End Encryption",
  "settings.item.security.desc": "AES-256-GCM cryptographic protection",
  "settings.item.sync.label": "Sync Policy",
  "settings.item.sync.desc": "Triggers, bookmark scopes & fallback",
  "settings.item.general.label": "Preferences & Device",
  "settings.item.general.desc": "Device name, theme & language",
  "settings.item.about.label": "About & Updates",
  "settings.item.about.desc": "Version info, updates & license",
