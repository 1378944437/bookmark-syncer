...
export const dictionary: Record<string, string> = {
  ...
  "settings.section.sync": "同步与范围",
  "settings.section.preferences": "偏好与设备",
  "settings.section.system": "关于与支持",

  "settings.item.webdav.label": "WebDAV 配置",
  "settings.item.webdav.desc": "服务器连接与服务商预设",
  "settings.item.security.label": "端到端加密",
  "settings.item.security.desc": "AES-256-GCM 本地密匙保护",
  "settings.item.sync.label": "同步策略",
  "settings.item.sync.desc": "触发方式、同步范围与容错",
  "settings.item.general.label": "偏好与设备",
  "settings.item.general.desc": "设备名称、外观主题与语言",
  "settings.item.about.label": "关于与更新",
  "settings.item.about.desc": "版本信息、检查更新与开源",
